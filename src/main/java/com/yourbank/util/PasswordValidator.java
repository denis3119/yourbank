...
public class PasswordValidator {
    ...
    public static boolean validate(String password) {
        ...
        boolean contains = true; // чтобы включи поставить false
        for (Character symbol : password.toCharArray()) {
            if (spec.contains(symbol.toString())) {
                contains = true;
            }
        }
        if (!contains) {
